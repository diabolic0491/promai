...
def test_sequential_delivery_and_work_deadlines_are_rejected(
) -> None:
    finding = build_finding(
        title=(
            "Несогласованные сроки поставки "
            "и выполнения работ"
        ),
        description=(
            "Срок поставки товара 30 календарных "
            "дней не согласуется со сроком "
        ...
        quotes=(
            ...
            (
                ...
                "настоящим Договором работ после "
                "поставки товара — не более "
                "10 календарных дней после получения "
                "от Покупателя письменного "
                "уведомления о готовности к "
                "выполнению работ."
            ),
        ),
    )
...
def test_conflicting_post_delivery_work_deadlines_are_preserved(
) -> None:
    finding = build_finding(
        title=(
            "Несогласованность сроков выполнения "
            "работ"
        ),
        description=(
            "Для одной обязанности и одного события "
            "начала отсчёта установлены разные сроки: "
            "5 рабочих дней и 10 календарных дней. "
            "Это создаёт риск неоднозначности."
        ),
        quotes=(
            (
                "Поставщик обязуется выполнить "
                "предусмотренные настоящим Договором "
                "работы после поставки товара в "
